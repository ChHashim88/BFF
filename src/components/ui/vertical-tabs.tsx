...
const SERVICES = [
  {
    ...
    image:
      "/Images 3/44f080324d08a880500d7d5e0efe4a5d.jpg",
  },
  {
    id: "02",
    title: "Visbility",
    ...
    image:
      "/Images 3/cd6464dd9316fd785f3fbe84fcda9c06.jpg",
  },
  {
    id: "03",
    title: "Consolidation",
    ...
    image:
      "/Images 3/572ddc73558974f2cd0ede5822489166.jpg",
  },
];
          ...
          <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 pt-4">
            <div className="space-y-1 mb-12">
              <h2 className="tracking-tighter text-balance text-3xl font-medium md:text-4xl lg:text-5xl text-foreground">
                Radical Transparency. Delivered Through the Platform.
              </h2>
            </div>
                ...
                >
                  ...
                  >
                    <img
                      ...
                      className="w-full h-full object-cover transition-transform duration-700 hover:scale-105 block m-0 p-0"
                    />
